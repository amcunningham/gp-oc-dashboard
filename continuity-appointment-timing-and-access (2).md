...
- **Age profile:** nine GPPS practice-level respondent age-band shares, calculated by dividing each age band’s published weighted response count by the total weighted response count. This retains very small shares represented as −98 in the published percentage fields. “Prefer not to say” was omitted as the reference category in the regression models.
...
Each outcome used the official Ipsos GPPS weighted summary definition reported in the `.counteval` and `.pcteval` fields. No bespoke favourable-response grouping was created for the main analysis. The response categories counted in the numerator and denominator were:

| Outcome used in this analysis | Responses counted as a favourable result | Responses included in the denominator |
|---|---|---|
| **Good overall experience of the GP practice** | “Very good” or “Fairly good” | All five responses: “Very good”, “Fairly good”, “Neither good nor poor”, “Fairly poor” and “Very poor” |
| **Wait acceptable** | “It was about right” | “It was about right” or “It took too long”; “I don’t know” was excluded |
| **Needs met at the last appointment** | “Yes, definitely” or “Yes, to some extent” | Those two responses plus “No, not at all”; “I don’t know” was excluded |
| **Confidence and trust in the healthcare professional** | “Yes, definitely” or “Yes, to some extent” | Those two responses plus “No, not at all”; “I don’t know or it didn’t apply” was excluded |
| **Involved as much as wanted in decisions about care and treatment** | “Yes, definitely” or “Yes, to some extent” | Those two responses plus “No, not at all”; “I can’t remember or it didn’t apply” was excluded |

“Wait acceptable” is described in the text as **experienced access** because it records the patient’s assessment of whether the wait was acceptable, rather than the number of days they waited.
...
Model 1 was weighted by the outcome-specific eligible-response base because it uses GPPS measures alone and the number of respondents contributing to each outcome varies. Models incorporating GPAD were weighted by the total number of GPPS responses to provide a consistent practice-level weight across outcomes and data sources.
...
### Sensitivity analysis: “Yes, definitely” only

The official summary measures for needs met, confidence and trust, and involvement count both “Yes, definitely” and “Yes, to some extent” as favourable. A sensitivity analysis applied the same Model 1 specification but used only the published weighted count for “Yes, definitely” as the outcome numerator. The eligible denominator was unchanged.

### Table 6a. Adjusted associations when the outcome was “Yes, definitely” only

| Outcome | Weighted mean | 10-point increase in continuity | 10-point increase in GPPS-reported same/next-day appointments |
|---|---:|---:|---:|
| Needs met — “Yes, definitely” | 58.2% | **+2.63 [2.48, 2.77]** | +1.50 [1.34, 1.66] |
| Confidence and trust — “Yes, definitely” | 64.2% | **+2.73 [2.58, 2.87]** | +1.03 [0.86, 1.21] |
| Involved in decisions — “Yes, definitely” | 62.2% | **+2.59 [2.44, 2.74]** | +1.06 [0.89, 1.23] |

*Cells show the percentage-point difference associated with a 10-percentage-point increase in the relevant predictor [95% confidence interval], with the other Model 1 variables held constant. Outcomes were constructed from the published weighted category counts and eligible-response bases. Models used the outcome-specific weighted eligible-response base; n=6,109 complete practices for each outcome.*

The continuity associations were larger when the outcome required an unequivocally positive response. This supports the main finding but does not make the analysis causal: it remains a cross-sectional association between practice-level measures.
...
- Needs met, confidence and trust, and involvement are rated highly in most practices, limiting the absolute size of observable differences. The official favourable definition is also broad because it combines “Yes, definitely” with “Yes, to some extent”. The definitely-only sensitivity analysis produced lower means and larger continuity associations, but it remains subject to the same cross-sectional and practice-level limitations.
